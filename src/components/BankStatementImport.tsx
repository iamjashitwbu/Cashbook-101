  ...
  return (
    <>
      ...
      {isOpen && (
       ...
       <div className="w-full overflow-hidden rounded-2xl bg-white shadow-2xl flex flex-col max-h-[90vh]">
           ...
           <div className="space-y-5 px-6 py-5 overflow-y-auto flex-1">
                ...
                {previewEntries.length > 0 && (
                  ...
                  <div className="max-h-[12rem] overflow-auto rounded-xl border border-gray-200">
