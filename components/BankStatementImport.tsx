...
import {
  convertExtractedRowsToPreviewEntries,
...
export const BankStatementImport = ({
  ...
  const handleFileChange = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (fileType === 'pdf') {
        const extractedRows = await processBankStatementPdf(file);
        nextPreviewEntries = convertExtractedRowsToPreviewEntries(extractedRows);
      } else {
